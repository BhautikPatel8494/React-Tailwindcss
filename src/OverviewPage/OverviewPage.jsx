      ...
      <div className="pb-4">
        <div className="space-y-1 p-5">
          ...
          <div class="flex items-center">
            <img
              class="rounded-full border-4 border-gray-800 shadow-sm"
              src={mainProfile}
              height="50"
              width="50"
              alt="userImage"
          ...
          {selectedValue === 1 && (
            <div className="info mt-5">
              <div className="space-y-4">
                <h3>Overview</h3>
                <p>
                  digital ninjas are a collection of 1000 unique collectibles on
                  the NEAR blockchain that serve to honor and preserve art.
                </p>
              </div>
            </div>
          )}
              ...
              <div className="space-y-4">
                <div className="flex">
                  ...
                  <div className="mx-2 space-y-1">
                    <p>
                      <span className="text-slate-400">Lorem ipsum</span> dolor
